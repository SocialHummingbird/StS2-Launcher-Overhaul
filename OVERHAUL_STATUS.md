...
- Build and publish the PowerVR touch-compatibility candidate only when explicitly requested, then retest it on Pixel/PowerVR hardware before calling issue #34 resolved.
