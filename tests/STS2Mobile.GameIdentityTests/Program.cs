...
internal static partial class Program
{
    private static int Main()
    {
        ...
        var tests = new (string Name, Action Run)[]
        {
            ...
            ("issue 37 ARM64 restores FMOD runtime pieces", Issue37Arm64RestoresFmodRuntimePieces),
            ("issue 37 ARM64 enables and repairs FMOD managers", Issue37Arm64EnablesAndRepairsFmodManagers),
            ("issue 37 x86 disables FMOD scene usage", Issue37X86DisablesFmodSceneUsage),
            ("issue 37 PCK preparation precedes GameIdentity", Issue37PckPreparationPrecedesGameIdentity),
            ("issue 37 repair changes identity and rebuilds runtime pack", Issue37RepairChangesIdentityAndRebuildsRuntimePack),
