function Add-SteamVersionSelectionPortalUxInstallCloudFlagChecks {
    Add-Check `
        ...
        @(
            ...
            "CompactHomeActionPrioritySupported\s*=\s*true",
            "CloudControlsIsolatedToSavesSupported\s*=\s*true",
            "VersionControlsIsolatedToVersionsSupported\s*=\s*true",
            "ModsControlsIsolatedToModsSupported\s*=\s*true",
            "HelpControlsIsolatedToHelpSupported\s*=\s*true",
            ...
            "CompactCloudSafetyCueBesideActionsSupported\s*=\s*true",
            ...
            "DestinationSupportToolsSupported\s*=\s*true",
            ...
            "DestinationPageOriginResetSupported\s*=\s*true",
            "LegacyPrimaryActionScrollAnchorsRemoved\s*=\s*true",
            "LegacyPaddedScrollAnchorsRemoved\s*=\s*true",
