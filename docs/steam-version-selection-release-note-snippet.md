...
This is still a hardening feature, not release-candidate signoff. Beta password entry, inaccessible/private branch behavior, native startup routing, cache cleanup, Android/Samsung/password-manager Autofill behavior, save compatibility across branches, and Steam Cloud Push safety after branch switching still require ARM64 validation evidence.
