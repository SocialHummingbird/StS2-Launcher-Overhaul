...
versionCode=288000
validation=build/static-gate only for the focused Steam version-selection UI/support audit split; device runtime signoff still requires the public/public-beta evidence workflow below
```
