...
versionCode=287000
validation=build/static-gate only for the expanded Steam version-selection static-audit orchestrator split; device runtime signoff still requires the public/public-beta evidence workflow below
```
