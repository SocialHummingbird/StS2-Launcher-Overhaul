...
- Latest published APK prerelease: `v0.2.285-local-audit-module-split`
- Current APK asset: `StS2Launcher-v0.2.285-local-audit-module-split-arm64-v8a.apk`
- Package name: `com.sts2launcher.overhaul.fork.local`
- Release asset SHA-256: `d54bae165b3f1afff9727e7bc277d02164ea3cc9e892567e8c782a4dbd7f84d5`
- Latest local ARM64 build APK: `0.2.285-local-audit-module-split` / `versionCode=285000`, artifact `artifacts/android/StS2Launcher-v0.2.285-local-audit-module-split-arm64-v8a.apk`, SHA-256 `d54bae165b3f1afff9727e7bc277d02164ea3cc9e892567e8c782a4dbd7f84d5`. This is a build/static-audit prerelease for the Steam version-selection audit module split; it does not replace the existing device evidence for public/public-beta runtime behavior. No Steam Cloud Push was run during this validation.
...
.\scripts\verify-android-release-apk.ps1 `
  -ReleaseTag "v0.2.285-local-audit-module-split" `
  -AssetName "StS2Launcher-v0.2.285-local-audit-module-split-arm64-v8a.apk" `
  -Abi arm64-v8a
...
VersionCode: 285000
SHA-256: d54bae165b3f1afff9727e7bc277d02164ea3cc9e892567e8c782a4dbd7f84d5
```
