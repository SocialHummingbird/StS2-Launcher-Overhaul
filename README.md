...
- Latest published APK prerelease: `v0.2.280-local-evidence-redaction-refactor`
- Current APK asset: `StS2Launcher-v0.2.280-local-evidence-redaction-refactor-arm64-v8a.apk`
- Package name: `com.sts2launcher.overhaul.fork.local`
- Release asset SHA-256: `193c3b7ccf768561f7cd4e89658a67476da3fecb6f3fa3dc9b0e07b20941fc19`
- Latest local ARM64 build APK: `0.2.280-local-evidence-redaction-refactor` / `versionCode=280000`, artifact `artifacts/android/StS2Launcher-v0.2.280-local-evidence-redaction-refactor-arm64-v8a.apk`, SHA-256 `193c3b7ccf768561f7cd4e89658a67476da3fecb6f3fa3dc9b0e07b20941fc19`. This is a build/static-audit prerelease for shared evidence path/redaction helper extraction; it does not replace the existing device evidence for public/public-beta runtime behavior.
...
.\scripts\verify-android-release-apk.ps1 `
  -ReleaseTag "v0.2.280-local-evidence-redaction-refactor" `
  -AssetName "StS2Launcher-v0.2.280-local-evidence-redaction-refactor-arm64-v8a.apk" `
  -Abi arm64-v8a
...
```text
Release: v0.2.280-local-evidence-redaction-refactor
Asset: StS2Launcher-v0.2.280-local-evidence-redaction-refactor-arm64-v8a.apk
Package: com.sts2launcher.overhaul.fork.local
VersionName: 0.2.280-local-evidence-redaction-refactor
VersionCode: 280000
SHA-256: 193c3b7ccf768561f7cd4e89658a67476da3fecb6f3fa3dc9b0e07b20941fc19
```
