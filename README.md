...
- Latest published APK prerelease: `v0.2.279-local-audit-helper-refactor`
- Current APK asset: `StS2Launcher-v0.2.279-local-audit-helper-refactor-arm64-v8a.apk`
- Package name: `com.sts2launcher.overhaul.fork.local`
- Release asset SHA-256: `3e388d6f835468dd2ba88a193a1e5d08981bd38ffb0b2bfa2fe1d155dee12b9d`
- Latest local ARM64 build APK: `0.2.279-local-audit-helper-refactor` / `versionCode=279000`, artifact `artifacts/android/StS2Launcher-v0.2.279-local-audit-helper-refactor-arm64-v8a.apk`, SHA-256 `3e388d6f835468dd2ba88a193a1e5d08981bd38ffb0b2bfa2fe1d155dee12b9d`. This is a build/static-audit prerelease for shared audit/evidence helper extraction; it does not replace the existing device evidence for public/public-beta runtime behavior.
...
.\scripts\verify-android-release-apk.ps1 `
  -ReleaseTag "v0.2.279-local-audit-helper-refactor" `
  -AssetName "StS2Launcher-v0.2.279-local-audit-helper-refactor-arm64-v8a.apk" `
  -Abi arm64-v8a
