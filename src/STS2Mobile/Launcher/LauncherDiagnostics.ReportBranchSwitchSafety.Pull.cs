...
internal static partial class LauncherDiagnostics
{
    ...
    )
    {
        ...
        sb.AppendLine($"Manual Pull outcome: {LauncherCloudSyncEvidence.LastManualPullOutcome(dataDir)}");
        sb.AppendLine($"Manual Pull outcome detail: {LauncherCloudSyncEvidence.LastManualPullOutcomeDetail(dataDir)}");
        sb.AppendLine($"Manual Pull completed: {BoolText(LauncherCloudSyncEvidence.LastManualPullCompletionRecorded(dataDir))}");
