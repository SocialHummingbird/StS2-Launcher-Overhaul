...
internal static partial class LauncherDiagnostics
{
    ...
    private static void AppendLauncherPreferences(StringBuilder sb, string dataDir)
    {
        ...
        sb.AppendLine($"Launcher compact plain-language status copy supported: {BoolText(LauncherPortalUxSupport.CompactPlainLanguageStatusCopySupported)}");
        ...
        sb.AppendLine($"Launcher compact low-profile safe-flow toggle supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileSafeFlowToggleSupported)}");
        sb.AppendLine($"Launcher compact safe-flow toggle detail labels supported: {BoolText(LauncherPortalUxSupport.CompactSafeFlowToggleDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact structured safe-flow toggle labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredSafeFlowToggleLabelsSupported)}");
        sb.AppendLine($"Launcher compact safe-flow bounded guide supported: {BoolText(LauncherPortalUxSupport.CompactSafeFlowBoundedGuideSupported)}");
        sb.AppendLine($"Launcher compact plain-language Quick Start labels supported: {BoolText(LauncherPortalUxSupport.CompactPlainLanguageQuickStartLabelsSupported)}");
        ...
        sb.AppendLine($"Launcher compact dense panel padding supported: {BoolText(LauncherPortalUxSupport.CompactDensePanelPaddingSupported)}");
        sb.AppendLine($"Launcher compact dense vertical rhythm supported: {BoolText(LauncherPortalUxSupport.CompactDenseVerticalRhythmSupported)}");
        sb.AppendLine($"Launcher rounded scaled metrics supported: {BoolText(LauncherPortalUxSupport.RoundedScaledLauncherMetricsSupported)}");
        sb.AppendLine($"Launcher Android compact touch-scale floor supported: {BoolText(LauncherPortalUxSupport.AndroidCompactTouchScaleFloorSupported)}");
        sb.AppendLine($"Launcher Android-readable warmup screen supported: {BoolText(LauncherPortalUxSupport.AndroidReadableWarmupScreenSupported)}");
        sb.AppendLine($"Launcher Android-readable startup status card supported: {BoolText(LauncherPortalUxSupport.AndroidReadableStartupStatusCardSupported)}");
        ...
        sb.AppendLine($"Launcher compact stacked status header supported: {BoolText(LauncherPortalUxSupport.CompactStackedStatusHeaderSupported)}");
        sb.AppendLine($"Launcher compact low-profile status card supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileStatusCardSupported)}");
        sb.AppendLine($"Launcher compact status headline row supported: {BoolText(LauncherPortalUxSupport.CompactStatusHeadlineRowSupported)}");
        sb.AppendLine($"Launcher compact stacked status headline supported: {BoolText(LauncherPortalUxSupport.CompactStackedStatusHeadlineSupported)}");
        sb.AppendLine($"Launcher viewport-aware compact status headline reflow supported: {BoolText(LauncherPortalUxSupport.ViewportAwareCompactStatusHeadlineReflowSupported)}");
        sb.AppendLine($"Launcher compact stable status detail row supported: {BoolText(LauncherPortalUxSupport.CompactStableStatusDetailRowSupported)}");
        sb.AppendLine($"Launcher compact short status details supported: {BoolText(LauncherPortalUxSupport.CompactShortStatusDetailsSupported)}");
        sb.AppendLine($"Launcher compact status tap-to-expand details supported: {BoolText(LauncherPortalUxSupport.CompactStatusTapToExpandDetailsSupported)}");
        sb.AppendLine($"Launcher compact touch-safe status detail button supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeStatusDetailButtonSupported)}");
        sb.AppendLine($"Launcher compact status detail cue supported: {BoolText(LauncherPortalUxSupport.CompactStatusDetailCueSupported)}");
        sb.AppendLine($"Launcher compact workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactWorkflowStepStripSupported)}");
        sb.AppendLine($"Launcher compact two-column workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactTwoColumnWorkflowStripSupported)}");
        sb.AppendLine($"Launcher compact single-row numbered workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactSingleRowNumberedWorkflowStripSupported)}");
        sb.AppendLine($"Launcher compact narrow workflow single-row supported: {BoolText(LauncherPortalUxSupport.CompactNarrowWorkflowSingleRowSupported)}");
        sb.AppendLine($"Launcher compact visible workflow step labels supported: {BoolText(LauncherPortalUxSupport.CompactVisibleWorkflowStepLabelsSupported)}");
        sb.AppendLine($"Launcher compact workflow step detail labels supported: {BoolText(LauncherPortalUxSupport.CompactWorkflowStepDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact workflow step number badges supported: {BoolText(LauncherPortalUxSupport.CompactWorkflowStepNumberBadgesSupported)}");
        sb.AppendLine($"Launcher compact readable workflow step number badges supported: {BoolText(LauncherPortalUxSupport.CompactReadableWorkflowStepNumberBadgesSupported)}");
        sb.AppendLine($"Launcher compact workflow unified touch height supported: {BoolText(LauncherPortalUxSupport.CompactWorkflowUnifiedTouchHeightSupported)}");
        sb.AppendLine($"Launcher compact sticky workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactStickyWorkflowStepStripSupported)}");
        sb.AppendLine($"Launcher compact low-profile workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileWorkflowStepStripSupported)}");
        sb.AppendLine($"Launcher compact low-profile two-column workflow step strip supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileTwoColumnWorkflowStepStripSupported)}");
        sb.AppendLine($"Launcher compact workflow step direct navigation supported: {BoolText(LauncherPortalUxSupport.CompactWorkflowStepDirectNavigationSupported)}");
        sb.AppendLine($"Launcher compact current-task jump supported: {BoolText(LauncherPortalUxSupport.CompactCurrentTaskJumpSupported)}");
        sb.AppendLine($"Launcher compact sticky current-task bar supported: {BoolText(LauncherPortalUxSupport.CompactStickyCurrentTaskBarSupported)}");
        sb.AppendLine($"Launcher compact low-profile current-task bar supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileCurrentTaskBarSupported)}");
        sb.AppendLine($"Launcher compact dense inline current-task bar supported: {BoolText(LauncherPortalUxSupport.CompactDenseInlineCurrentTaskBarSupported)}");
        sb.AppendLine($"Launcher compact current-task shared touch height supported: {BoolText(LauncherPortalUxSupport.CompactCurrentTaskSharedTouchHeightSupported)}");
        sb.AppendLine($"Launcher compact low-profile stacked current-task bar supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileStackedCurrentTaskBarSupported)}");
        sb.AppendLine($"Launcher compact current-task context labels supported: {BoolText(LauncherPortalUxSupport.CompactCurrentTaskContextLabelsSupported)}");
        sb.AppendLine($"Launcher compact structured current-task labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredCurrentTaskLabelsSupported)}");
        sb.AppendLine($"Launcher compact current-task short title labels supported: {BoolText(LauncherPortalUxSupport.CompactCurrentTaskShortTitleLabelsSupported)}");
        sb.AppendLine($"Launcher compact touch-safe sticky header controls supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeStickyHeaderControlsSupported)}");
        sb.AppendLine($"Launcher compact grouped sticky task header supported: {BoolText(LauncherPortalUxSupport.CompactGroupedStickyTaskHeaderSupported)}");
        sb.AppendLine($"Launcher compact sticky task toolbar shell supported: {BoolText(LauncherPortalUxSupport.CompactStickyTaskToolbarShellSupported)}");
        sb.AppendLine($"Launcher compact inline sticky task header supported: {BoolText(LauncherPortalUxSupport.CompactInlineStickyTaskHeaderSupported)}");
        sb.AppendLine($"Launcher compact responsive sticky task header supported: {BoolText(LauncherPortalUxSupport.CompactResponsiveStickyTaskHeaderSupported)}");
        sb.AppendLine($"Launcher viewport-aware sticky task header reflow supported: {BoolText(LauncherPortalUxSupport.ViewportAwareStickyTaskHeaderReflowSupported)}");
        sb.AppendLine($"Launcher viewport-aware compact task re-anchor supported: {BoolText(LauncherPortalUxSupport.ViewportAwareCompactTaskReanchorSupported)}");
        sb.AppendLine($"Launcher compact dense sticky task header supported: {BoolText(LauncherPortalUxSupport.CompactDenseStickyTaskHeaderSupported)}");
        sb.AppendLine($"Launcher compact task-jump navigation labels supported: {BoolText(LauncherPortalUxSupport.CompactTaskJumpNavigationLabelsSupported)}");
        sb.AppendLine($"Launcher compact readable detail label font supported: {BoolText(LauncherPortalUxSupport.CompactReadableDetailLabelFontSupported)}");
        sb.AppendLine($"Launcher compact touch-safe confirmation dialogs supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeConfirmationDialogsSupported)}");
        sb.AppendLine($"Launcher compact scroll-safe confirmation dialogs supported: {BoolText(LauncherPortalUxSupport.CompactScrollSafeConfirmationDialogsSupported)}");
        sb.AppendLine($"Launcher compact contextual confirmation labels supported: {BoolText(LauncherPortalUxSupport.CompactContextualConfirmationLabelsSupported)}");
        sb.AppendLine($"Launcher viewport-aware confirmation dialogs supported: {BoolText(LauncherPortalUxSupport.ViewportAwareConfirmationDialogsSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard large input supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardLargeInputSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard action-first layout supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardActionFirstSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard inline action row supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardInlineActionRowSupported)}");
        sb.AppendLine($"Launcher compact responsive Steam Guard action layout supported: {BoolText(LauncherPortalUxSupport.CompactResponsiveSteamGuardActionLayoutSupported)}");
        sb.AppendLine($"Launcher viewport-aware compact Steam Guard action row reflow supported: {BoolText(LauncherPortalUxSupport.ViewportAwareCompactSteamGuardActionRowReflowSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard submit detail label supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardSubmitDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard retry guidance supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardRetryGuidanceSupported)}");
        sb.AppendLine($"Launcher compact Steam Guard bounded helper supported: {BoolText(LauncherPortalUxSupport.CompactSteamGuardBoundedHelperSupported)}");
        sb.AppendLine($"Launcher compact primary retry action supported: {BoolText(LauncherPortalUxSupport.CompactPrimaryRetryActionSupported)}");
        sb.AppendLine($"Launcher compact structured retry action labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredRetryActionLabelsSupported)}");
        sb.AppendLine($"Launcher compact primary login action first supported: {BoolText(LauncherPortalUxSupport.CompactPrimaryLoginActionFirstSupported)}");
        sb.AppendLine($"Launcher compact Android login primary CTA supported: {BoolText(LauncherPortalUxSupport.CompactAndroidLoginPrimaryCtaSupported)}");
        sb.AppendLine($"Launcher compact Android login detail label supported: {BoolText(LauncherPortalUxSupport.CompactAndroidLoginDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact Android login helper detail label supported: {BoolText(LauncherPortalUxSupport.CompactAndroidLoginHelperDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact completed-auth section suppression supported: {BoolText(LauncherPortalUxSupport.CompactCompletedAuthSectionSuppressionSupported)}");
        ...
        sb.AppendLine($"Launcher compact launch detail label supported: {BoolText(LauncherPortalUxSupport.CompactLaunchDetailLabelSupported)}");
        ...
        sb.AppendLine($"Launcher compact condensed brand header supported: {BoolText(LauncherPortalUxSupport.CompactCondensedBrandHeaderSupported)}");
        sb.AppendLine($"Launcher compact single-line brand header supported: {BoolText(LauncherPortalUxSupport.CompactSingleLineBrandHeaderSupported)}");
        sb.AppendLine($"Launcher compact readable brand subtitle supported: {BoolText(LauncherPortalUxSupport.CompactReadableBrandSubtitleSupported)}");
        ...
        sb.AppendLine($"Launcher compact low-profile section headers supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileSectionHeadersSupported)}");
        sb.AppendLine($"Launcher compact single-row section headers supported: {BoolText(LauncherPortalUxSupport.CompactSingleRowSectionHeadersSupported)}");
        sb.AppendLine($"Launcher compact section-header task cues supported: {BoolText(LauncherPortalUxSupport.CompactSectionHeaderTaskCueSupported)}");
        sb.AppendLine($"Launcher compact readable section-header cues supported: {BoolText(LauncherPortalUxSupport.CompactReadableSectionHeaderCuesSupported)}");
        sb.AppendLine($"Launcher compact explicit section-header cues supported: {BoolText(LauncherPortalUxSupport.CompactExplicitSectionHeaderCuesSupported)}");
        sb.AppendLine($"Launcher compact install primary action first supported: {BoolText(LauncherPortalUxSupport.CompactInstallPrimaryActionFirstSupported)}");
        sb.AppendLine($"Launcher compact install primary detail label supported: {BoolText(LauncherPortalUxSupport.CompactInstallPrimaryDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact download progress hero supported: {BoolText(LauncherPortalUxSupport.CompactDownloadProgressHeroSupported)}");
        sb.AppendLine($"Launcher compact download progress status label supported: {BoolText(LauncherPortalUxSupport.CompactDownloadProgressStatusLabelSupported)}");
        sb.AppendLine($"Launcher compact readable download progress bar supported: {BoolText(LauncherPortalUxSupport.CompactReadableDownloadProgressBarSupported)}");
        sb.AppendLine($"Launcher compact inline install-version controls supported: {BoolText(LauncherPortalUxSupport.CompactInlineInstallVersionControlsSupported)}");
        ...
        sb.AppendLine($"Launcher compact version drawer detail labels supported: {BoolText(LauncherPortalUxSupport.CompactVersionDrawerDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact version drawer bounded help label supported: {BoolText(LauncherPortalUxSupport.CompactVersionDrawerBoundedHelpLabelSupported)}");
        sb.AppendLine($"Launcher compact structured install-version action labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredInstallVersionActionLabelsSupported)}");
        sb.AppendLine($"Launcher compact selected-version summary supported: {BoolText(LauncherPortalUxSupport.CompactSelectedVersionSummarySupported)}");
        sb.AppendLine($"Launcher compact version summary cards supported: {BoolText(LauncherPortalUxSupport.CompactVersionSummaryCardsSupported)}");
        sb.AppendLine($"Launcher compact selected-version summary shortcut supported: {BoolText(LauncherPortalUxSupport.CompactSelectedVersionSummaryShortcutSupported)}");
        sb.AppendLine($"Launcher compact selected-version headline supported: {BoolText(LauncherPortalUxSupport.CompactSelectedVersionHeadlineSupported)}");
        sb.AppendLine($"Launcher compact responsive selected-version summary supported: {BoolText(LauncherPortalUxSupport.CompactResponsiveSelectedVersionSummarySupported)}");
        sb.AppendLine($"Launcher compact ready-version summary supported: {BoolText(LauncherPortalUxSupport.CompactReadyVersionSummarySupported)}");
        sb.AppendLine($"Launcher compact ready-version summary panel supported: {BoolText(LauncherPortalUxSupport.CompactReadyVersionSummaryPanelSupported)}");
        sb.AppendLine($"Launcher compact ready-version summary shortcut supported: {BoolText(LauncherPortalUxSupport.CompactReadyVersionSummaryShortcutSupported)}");
        sb.AppendLine($"Launcher compact ready-version headline supported: {BoolText(LauncherPortalUxSupport.CompactReadyVersionSummaryHeadlineSupported)}");
        sb.AppendLine($"Launcher compact responsive ready-version summary supported: {BoolText(LauncherPortalUxSupport.CompactResponsiveReadyVersionSummarySupported)}");
        sb.AppendLine($"Launcher compact ready-state priority supported: {BoolText(LauncherPortalUxSupport.CompactReadyStatePrioritySupported)}");
        sb.AppendLine($"Launcher compact ready-state cloud options below launch supported: {BoolText(LauncherPortalUxSupport.CompactReadyStateCloudOptionsBelowLaunchSupported)}");
        sb.AppendLine($"Launcher compact Play/Sync drawer detail labels supported: {BoolText(LauncherPortalUxSupport.CompactPlaySyncDrawerDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact structured Play/Sync action labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredPlaySyncActionLabelsSupported)}");
        sb.AppendLine($"Launcher compact plain-language Play/Sync labels supported: {BoolText(LauncherPortalUxSupport.CompactPlainLanguagePlaySyncLabelsSupported)}");
        sb.AppendLine($"Launcher compact ready-state install-section suppression supported: {BoolText(LauncherPortalUxSupport.CompactReadyStateInstallSectionSuppressionSupported)}");
        sb.AppendLine($"Launcher compact touch-safe version dropdown supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeVersionDropdownSupported)}");
        sb.AppendLine($"Launcher compact touch-safe dropdown popup supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeDropdownPopupSupported)}");
        ...
        sb.AppendLine($"Launcher compact cloud-safety cue before actions supported: {BoolText(LauncherPortalUxSupport.CompactCloudSafetyCueBeforeActionsSupported)}");
        sb.AppendLine($"Launcher compact cloud-safety detail label supported: {BoolText(LauncherPortalUxSupport.CompactCloudSafetyDetailLabelSupported)}");
        ...
        sb.AppendLine($"Launcher compact cloud direction labels supported: {BoolText(LauncherPortalUxSupport.CompactCloudDirectionLabelsSupported)}");
        sb.AppendLine($"Launcher compact cloud primary actions row supported: {BoolText(LauncherPortalUxSupport.CompactCloudPrimaryActionsRowSupported)}");
        sb.AppendLine($"Launcher compact Pull detail label supported: {BoolText(LauncherPortalUxSupport.CompactCloudPullDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact locked Push detail labels supported: {BoolText(LauncherPortalUxSupport.CompactCloudPushLockDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact dangerous Push detail labels supported: {BoolText(LauncherPortalUxSupport.CompactCloudPushDangerDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact armed Push warning detail label supported: {BoolText(LauncherPortalUxSupport.CompactCloudPushWarningDetailLabelSupported)}");
        sb.AppendLine($"Launcher compact responsive action rows supported: {BoolText(LauncherPortalUxSupport.CompactResponsiveActionRowsSupported)}");
        ...
        sb.AppendLine($"Launcher compact cloud option labels supported: {BoolText(LauncherPortalUxSupport.CompactCloudOptionLabelsSupported)}");
        sb.AppendLine($"Launcher compact cloud option detail labels supported: {BoolText(LauncherPortalUxSupport.CompactCloudOptionDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact cloud options row supported: {BoolText(LauncherPortalUxSupport.CompactCloudOptionsRowSupported)}");
        sb.AppendLine($"Launcher compact drawer state reset supported: {BoolText(LauncherPortalUxSupport.CompactDrawerStateResetSupported)}");
        sb.AppendLine($"Launcher compact drawer toggle-first ordering supported: {BoolText(LauncherPortalUxSupport.CompactDrawerToggleFirstSupported)}");
        sb.AppendLine($"Launcher compact low-profile drawer toggles supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileDrawerTogglesSupported)}");
        sb.AppendLine($"Launcher compact dense drawer toggle height supported: {BoolText(LauncherPortalUxSupport.CompactDenseDrawerToggleHeightSupported)}");
        sb.AppendLine($"Launcher compact touch-safe drawer toggle sizing supported: {BoolText(LauncherPortalUxSupport.CompactTouchSafeDrawerToggleSizingSupported)}");
        sb.AppendLine($"Launcher compact support tools grid supported: {BoolText(LauncherPortalUxSupport.CompactSupportToolsGridSupported)}");
        sb.AppendLine($"Launcher compact support tool detail labels supported: {BoolText(LauncherPortalUxSupport.CompactSupportToolDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact launcher-log review label supported: {BoolText(LauncherPortalUxSupport.CompactRawLogReviewLabelSupported)}");
        sb.AppendLine($"Launcher compact drawer selection collapse supported: {BoolText(LauncherPortalUxSupport.CompactDrawerSelectionCollapseSupported)}");
        sb.AppendLine($"Launcher compact active-section scroll supported: {BoolText(LauncherPortalUxSupport.CompactActiveSectionScrollSupported)}");
        sb.AppendLine($"Launcher compact primary-action scroll anchors supported: {BoolText(LauncherPortalUxSupport.CompactPrimaryActionScrollAnchorsSupported)}");
        sb.AppendLine($"Launcher compact padded scroll anchors supported: {BoolText(LauncherPortalUxSupport.CompactPaddedScrollAnchorsSupported)}");
        sb.AppendLine($"Launcher compact bottom scroll breathing room supported: {BoolText(LauncherPortalUxSupport.CompactBottomScrollBreathingRoomSupported)}");
        sb.AppendLine($"Launcher compact low-profile attribution footer supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileAttributionSupported)}");
        sb.AppendLine($"Launcher viewport-aware keyboard offset supported: {BoolText(LauncherPortalUxSupport.ViewportAwareKeyboardOffsetSupported)}");
        sb.AppendLine($"Launcher keyboard-focused input scroll supported: {BoolText(LauncherPortalUxSupport.KeyboardFocusedInputScrollSupported)}");
        sb.AppendLine($"Launcher compact ready-state safe-flow suppression supported: {BoolText(LauncherPortalUxSupport.CompactReadyStateSafeFlowSuppressionSupported)}");
        sb.AppendLine($"Launcher compact active-task safe-flow suppression supported: {BoolText(LauncherPortalUxSupport.CompactActiveTaskSafeFlowSuppressionSupported)}");
        sb.AppendLine($"Launcher native fallback recovery actions styled: {BoolText(LauncherPortalUxSupport.NativeFallbackRecoveryActionsStyledSupported)}");
        sb.AppendLine($"Launcher native fallback diagnostics collapsed by default: {BoolText(LauncherPortalUxSupport.NativeFallbackDiagnosticsCollapsedSupported)}");
        sb.AppendLine($"Launcher native fallback responsive recovery rows supported: {BoolText(LauncherPortalUxSupport.NativeFallbackResponsiveRecoveryRowsSupported)}");
        sb.AppendLine($"Launcher startup recovery scroll-safe controls supported: {BoolText(LauncherPortalUxSupport.StartupRecoveryScrollSafeControlsSupported)}");
        sb.AppendLine($"Launcher startup recovery structured compact actions supported: {BoolText(LauncherPortalUxSupport.StartupRecoveryStructuredCompactActionsSupported)}");
        ...
        sb.AppendLine($"Launcher Help & Reports drawer hidden by default: {BoolText(LauncherPortalUxSupport.DiagnosticsConsoleHiddenByDefault)}");
        sb.AppendLine($"Launcher Help & Reports drawer auto-opens for diagnostics actions: {BoolText(LauncherPortalUxSupport.DiagnosticsConsoleAutoOpensForDiagnosticsActionsSupported)}");
        sb.AppendLine($"Launcher compact low-profile diagnostics toggle supported: {BoolText(LauncherPortalUxSupport.CompactLowProfileDiagnosticsToggleSupported)}");
        sb.AppendLine($"Launcher compact diagnostics toggle detail labels supported: {BoolText(LauncherPortalUxSupport.CompactDiagnosticsToggleDetailLabelsSupported)}");
        sb.AppendLine($"Launcher compact structured diagnostics toggle labels supported: {BoolText(LauncherPortalUxSupport.CompactStructuredDiagnosticsToggleLabelsSupported)}");
        sb.AppendLine($"Launcher plain-language help report copy supported: {BoolText(LauncherPortalUxSupport.PlainLanguageHelpReportCopySupported)}");
        sb.AppendLine($"Launcher compact diagnostics scroll-hosted supported: {BoolText(LauncherPortalUxSupport.CompactDiagnosticsScrollHostedSupported)}");
        sb.AppendLine($"Launcher compact readable diagnostics log supported: {BoolText(LauncherPortalUxSupport.CompactReadableDiagnosticsLogSupported)}");
        sb.AppendLine($"Launcher compact bounded diagnostics log viewport supported: {BoolText(LauncherPortalUxSupport.CompactBoundedDiagnosticsLogViewportSupported)}");
        sb.AppendLine($"Launcher viewport-aware diagnostics log resize supported: {BoolText(LauncherPortalUxSupport.ViewportAwareDiagnosticsLogResizeSupported)}");
