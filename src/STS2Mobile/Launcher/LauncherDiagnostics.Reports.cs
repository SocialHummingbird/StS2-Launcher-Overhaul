...
internal static partial class LauncherDiagnostics
{
    ...
    private static void AppendLauncherPreferences(StringBuilder sb, string dataDir)
    {
        ...
        sb.AppendLine($"Launcher compact raw-log review label supported: {BoolText(LauncherPortalUxSupport.CompactRawLogReviewLabelSupported)}");
        ...
        sb.AppendLine($"Launcher diagnostics console auto-opens for diagnostics actions: {BoolText(LauncherPortalUxSupport.DiagnosticsConsoleAutoOpensForDiagnosticsActionsSupported)}");
