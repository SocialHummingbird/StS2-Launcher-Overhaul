...
internal sealed partial class ActionSection
{
    private readonly record struct CloudControls(
        ...
        VBoxContainer OperationProgressGroup,
        Label OperationPhaseLabel,
        Label OperationDetailLabel,
        ProgressBar OperationProgressBar,
        Label PushEligibilityLabel,
    ...
    private CloudControls BuildCloudControls(float scale, bool compact)
    {
        ...
        return new CloudControls(
            ...
            primaryActions.CancelOperationButton,
            primaryActions.OperationProgressGroup,
            primaryActions.OperationPhaseLabel,
            primaryActions.OperationDetailLabel,
            primaryActions.OperationProgressBar,
            primaryActions.PushEligibilityLabel,
